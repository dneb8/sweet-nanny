...
<template>
  <div class="space-y-6">
    ...
    <div class="flex flex-wrap gap-3">
      <Button v-if="userPolicy.canUpdate(props.user)" @click="editUser" variant="secondary">
        <Icon icon="mdi:pencil-outline" class="w-4 h-4 mr-2" />
        Editar
      </Button>

      <Button v-if="userPolicy.canDelete(props.user)" @click="deleteUser" variant="destructive">
