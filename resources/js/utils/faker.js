...
const fakers = {
  fakeUsers() {
    ...
    return _.sampleSize(users, 3).map((user) => {
      return {
        name: user.name,
        gender: user.gender,
        username: _.toLower("@" + _.replace(user.name, / /g, "")),
  ...
  fakePhotos() {
    ...
    for (let i = 0; i < 15; i++) {
      photos[photos.length] =
        imageAssets[
          "/public/images/profile-" + _.random(1, 15) + ".jpg"
        ].default;
    }
  ...
  fakeImages() {
    ...
    for (let i = 0; i < 15; i++) {
      images[images.length] =
        imageAssets[
          "/public/images/preview-" + _.random(1, 15) + ".jpg"
        ].default;
    }
  ...
  fakeProducts() {
    const products = [
      { name: "Dell XPS 13", price: "$1,200", category: "PC & Laptop" },
      {
      ...
      { name: "Samsung Q90 QLED TV", price: "$950", category: "Electronic" },
      {
        name: "Nike Air Max 270",
        price: "$1,250",
        category: "Sport & Outdoor",
      },
      { name: "Nike Tanjun", price: "$525", category: "Sport & Outdoor" },
      { name: "Nikon Z6", price: "$670", category: "Photography" },
      { name: "Sony A7 III", price: "$875", category: "Photography" },
    ];
  ...
  fakeFoods() {
    const foods = [
      {
        name: "Vanilla Latte",
        image: imageAssets["/public/images/food-beverage-1.jpg"].default,
      },
      {
        name: "Milkshake",
        image: imageAssets["/public/images/food-beverage-2.jpg"].default,
      },
      {
        name: "Soft Drink",
        image: imageAssets["/public/images/food-beverage-3.jpg"].default,
      },
      {
        name: "Root Beer",
        image: imageAssets["/public/images/food-beverage-4.jpg"].default,
      },
      {
        name: "Pocari",
        image: imageAssets["/public/images/food-beverage-5.jpg"].default,
      },
      {
        name: "Ultimate Burger",
        image: imageAssets["/public/images/food-beverage-6.jpg"].default,
      },
      {
        name: "Hotdog",
        image: imageAssets["/public/images/food-beverage-7.jpg"].default,
      },
      {
        name: "Avocado Burger",
        image: imageAssets["/public/images/food-beverage-8.jpg"].default,
      },
      {
        name: "Spaghetti Fettucine Aglio with Beef Bacon",
        image: imageAssets["/public/images/food-beverage-9.jpg"].default,
      },
      {
        name: "Spaghetti Fettucine Aglio with Smoked Salmon",
        image: imageAssets["/public/images/food-beverage-10.jpg"].default,
      },
      {
        name: "Curry Penne and Cheese",
        image: imageAssets["/public/images/food-beverage-11.jpg"].default,
      },
      {
        name: "French Fries",
        image: imageAssets["/public/images/food-beverage-12.jpg"].default,
      },
      {
        name: "Virginia Cheese Fries",
        image: imageAssets["/public/images/food-beverage-13.jpg"].default,
      },
      {
        name: "Virginia Cheese Wedges",
        image: imageAssets["/public/images/food-beverage-14.jpg"].default,
      },
      {
        name: "Fried/Grilled Banana",
        image: imageAssets["/public/images/food-beverage-15.jpg"].default,
      },
      {
        name: "Crispy Mushroom",
        image: imageAssets["/public/images/food-beverage-16.jpg"].default,
      },
      {
        name: "Fried Calamari",
        image: imageAssets["/public/images/food-beverage-17.jpg"].default,
      },
      {
        name: "Chicken Wings",
        image: imageAssets["/public/images/food-beverage-18.jpg"].default,
      },
      {
        name: "Snack Platter",
        image: imageAssets["/public/images/food-beverage-19.jpg"].default,
      },
    ];
